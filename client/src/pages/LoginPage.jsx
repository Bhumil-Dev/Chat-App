...
const LoginPage = () => {
  ...
  return (
    <div className=' min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <form onSubmit={onSubmitHandler} className=' border bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        <input onChange={(e)=>setFullName(e.target.value)} value={fullName} type="text" className=' p-2 border-gray-500 border rounded-md focus:outline-none' placeholder='Full Name' required/>
        )}
        ...
        <button type='submit' className='py-3 bg-gradient-to-r from-purple-400 text-white rounded-md cursor-pointer to-violet-600'>
